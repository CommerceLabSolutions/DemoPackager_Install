...
class protostoreTask_completepayment
{
	...
	public function getResponse(Input $data)
	{
		...
		$orderid = $data->getString('paypalorderid');
		...
		$events = Factory::getApplication()->triggerEvent('onCompletePaymentPaypal', array($orderid));

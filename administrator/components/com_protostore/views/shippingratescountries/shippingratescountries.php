...
<div id="p2s_shippingratescountries" v-cloak>
                    ...
                    <div class="uk-card uk-card-default ">
                        ...
                        <div class="uk-card-body">
                            <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
                                ...
                                <li>
                                    <a class="uk-text-emphasis" href="index.php?option=com_protostore&view=shippingratescountry">
                                        <span class="uk-margin-small-right" uk-icon="icon: plus-circle"></span>
                                        Add Country Shipping Rate
                                    </a>
                                </li>

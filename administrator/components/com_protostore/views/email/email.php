			...
			<div class="uk-grid" uk-grid="">
				<div class="uk-width-1-1">
					...
					<div>
                        ...
                        <nav class="uk-navbar-container uk-padding-small uk-flex-wrap" uk-navbar style="border-radius: 8px">
							...
							<div class="uk-navbar-right">
								...
								<button type="submit" @click="andClose = true"  class="uk-button uk-button-default button-success uk-button-small uk-margin-right uk-margin-small-bottom">
				...
				<div class="uk-width-2-3@m uk-width-3-3@l uk-width-3-4@xl">
				...
				<div class="uk-width-1-3@m uk-width-3-2@l uk-width-1-4@xl">

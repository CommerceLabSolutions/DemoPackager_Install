...
<div id="p2s_shippingratescountry_form">
            ...
            <div class="uk-grid" uk-grid="">
                ...
                <div class="uk-width-2-3">
					...
					<?= LayoutHelper::render('card', array(
						'form'      => $vars['form'],
						'cardStyle' => 'default',
						'cardTitle' => 'COM_PROTOSTORE_ADD_SHIPPING_RATE_MODAL_COUNTRY_SHIPPING_RATE_DETAILS',
						'cardId'    => 'details',
						'fields'    => array('country_id', 'weight_from', 'weight_to', 'cost', 'handling_cost', 'published')
					)); ?>

...
class bootstrap extends AdminModel
{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_protostore.shippingratescountries', 'shippingratescountries', array('control' => 'jform', 'load_data' => $loadData));

		if ($item)
		{
			$form->setValue('country_id', null, $item->country_id);

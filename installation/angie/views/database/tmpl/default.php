...
<div id="restoration-dialog" class="uk-container uk-container-center uk-container-xsmall uk-margin-top" style="display: none">
    <div class="akeeba-renderer-fef">
        ...
        <div id="restoration-success">
            ...
            <button type="button" onclick="databaseBtnSuccessClick();" class="akeeba-btn--green" style="margin-bottom: 10px; float: right; color: #231d3f;">
                <span class="akion-arrow-right-c"></span>
			    <?php echo AText::_('DATABASE_BTN_SUCCESS'); ?>
            </button>
        </div>
        <div id="restoration-error" style="clear: both;">
...
<div class="uk-container uk-container-center uk-container-xsmall">
    <div>
        <div class="" style="margin-top: 0">
            ...
            <div class="uk-form">
                <div class="uk-margin-small" style="opacity: 0; height: 0;">
                ...
                <div class="uk-margin-small" uk-grid>
                    ...
                    <div class="uk-width-1-2">
                        <input class="uk-input uk-width-1-1" type="text" id="dbuser" placeholder="<?php echo AText::_('DATABASE_LBL_USERNAME') ?>" value="<?php echo $this->db->dbuser ?>" />
                    </div>
                    <span class="akeeba-help-text" style="display: none">
                ...
                <div class="uk-margin-small" uk-grid>
                    ...
                    <div class="uk-width-1-2">
                        <input class="uk-input uk-width-1-1" type="password" id="dbpass" placeholder="<?php echo AText::_('DATABASE_LBL_PASSWORD') ?>" value="<?php echo $this->db->dbpass ?>" />
                    </div>
                    <span class="akeeba-help-text" style="display: none">
                ...
                <div class="uk-margin-small" uk-grid>
                    ...
                    <div class="uk-width-1-2">
                        <input class="uk-input uk-width-1-1" type="text" id="dbname" placeholder="<?php echo AText::_('DATABASE_LBL_DBNAME') ?>" value="<?php echo $this->db->dbname ?>" />
                    </div>
                    <span class="akeeba-help-text" style="display: none">
				...
				<div class="akeeba-form-group" style="opacity: 0; height: 0;">
					...
					<input type="text" id="prefix" placeholder="<?php echo AText::_('DATABASE_LBL_PREFIX') ?>" value="clsdmo_" />
					<span class="akeeba-help-text" style="display: none">
	...
	<div id="advancedWrapper" class="akeeba-panel--info" style="margin-top: 0; display: none;">
        <header class="akeeba-block-header">

<?php // $file = C:/xampp/htdocs/joomla/joomla4/plugins/system/protostore/modules/core/elements/protostore_cartitems/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'protostore_cartitems', 
  'title' => 'Cart Items', 
  'icon' => $filter->apply('url', 'images/protostore_cartitems.svg', $file), 
  'iconSmall' => $filter->apply('url', 'images/protostore_cartitems_small.svg', $file), 
  'element' => true, 
  'container' => true, 
  ...
  'fields' => [
    ...
    'empty_text' => [
      'label' => 'Text to show on empty cart', 
      'type' => 'text'
    ], 
    'style' => [
      'label' => 'Panel Style', 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Setup', 
          'fields' => ['layout', 'include_tax', 'empty_text', 'title_style', 'title_decoration', 'title_font_family', 'title_color', 'title_element']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'General', 

<?php // $file = C:/xampp/htdocs/joomla/joomla4/plugins/system/protostore/modules/core/elements/protostore_cartsummary/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'protostore_cartsummary', 
  'title' => 'Cart Summary', 
  'icon' => $filter->apply('url', 'images/protostore_cartsummary.svg', $file), 
  'iconSmall' => $filter->apply('url', 'images/protostore_cartsummary_small.svg', $file), 
  'element' => true, 
  'container' => true, 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['hide_zero_tax', 'hide_zero_discount']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'General', 

<?php // $file = C:/xampp/htdocs/joomla/joomla4/plugins/system/protostore/modules/core/elements/protostore_couponfield/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'protostore_couponfield', 
  'title' => 'Coupon Field', 
  'icon' => $filter->apply('url', 'images/protostore_couponfield.svg', $file), 
  'iconSmall' => $filter->apply('url', 'images/protostore_couponfield.svg', $file), 
  'element' => true, 
  'container' => true, 

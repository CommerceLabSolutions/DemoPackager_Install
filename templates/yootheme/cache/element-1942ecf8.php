<?php // $file = C:/xampp/htdocs/joomla/joomla4/plugins/system/protostore/modules/core/elements/protostore_checkboxoptions/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'protostore_checkboxoptions', 
  'title' => 'Checkbox Options', 
  'icon' => $filter->apply('url', 'images/protostore_checkboxoptions.svg', $file), 
  'iconSmall' => $filter->apply('url', 'images/protostore_checkboxoptions_small.svg', $file), 
  'group' => 'Pro2Store', 
  'element' => true, 
  'templates' => [
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_style', 'panel_content_padding', 'panel_size']
            ]]
        ], [
          'title' => 'Settings', 
          'fields' => [[

<?php // $file = C:/xampp/htdocs/joomla/joomla4/plugins/system/protostore/modules/core/elements/protostore_checkoutnotes/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'protostore_checkoutnotes', 
  'title' => 'Checkout Notes', 
  'icon' => $filter->apply('url', 'images/protostore_checkoutnotes.svg', $file), 
  'iconSmall' => $filter->apply('url', 'images/protostore_checkoutnotes_small.svg', $file), 
  'element' => true, 
  'container' => true, 

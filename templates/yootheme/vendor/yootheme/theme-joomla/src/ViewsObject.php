...
class ViewsObject extends \ArrayObject
{
    ...
    protected function wrap($view)
    {
        ...
        // Call get name to set prop HtmlView::_name
        $view->getName();
        ...
        return $this->tap(
            (new \ReflectionClass($wrapper))->newInstanceWithoutConstructor(),
            function ($wrapper) use ($view) {
